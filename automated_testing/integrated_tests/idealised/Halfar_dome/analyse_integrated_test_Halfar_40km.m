...
filename_config  = [foldername_test '/config_Halfar_40km.cfg'];
filename_results = [foldername_test '/results_Halfar_40km/main_output_ANT_00001.nc'];
...
% Read stability info
filename = [foldername_test '/results_Halfar_40km/scalar_output_ANT_00001.nc'];
