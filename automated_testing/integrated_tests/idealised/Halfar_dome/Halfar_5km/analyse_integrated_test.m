...
foldername_test = [foldername_automated_testing '/integrated_tests/idealised/Halfar_dome/Halfar_5km'];
...
write_to_scoreboard_file( RMSE_Hi);
  ...
  function write_to_scoreboard_file( RMSE_Hi)
    ...
    test_name = 'integrated_tests_idealised_Halfar_dome_Halfar_5km';
    ...
    write_single_test_run_to_scoreboard_file( single_run, ...
      [foldername_automated_testing '/integrated_tests/idealised/Halfar_dome/Halfar_5km']);
