function analyse_integrated_test_Halfar_static_5km( varargin)
...
filename_config  = [foldername_test '/config_Halfar_static_5km.cfg'];
filename_results = [foldername_test '/results_Halfar_static_5km/main_output_ANT_00001.nc'];
...
% Read stability info
filename = [foldername_test '/results_Halfar_static_5km/scalar_output_ANT_00001.nc'];
