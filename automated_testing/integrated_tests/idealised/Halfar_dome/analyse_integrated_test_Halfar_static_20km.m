...
filename_config  = [foldername_test '/config_Halfar_static_20km.cfg'];
filename_results = [foldername_test '/results_Halfar_static_20km/main_output_ANT_00001.nc'];
...
% Read stability info
filename = [foldername_test '/results_Halfar_static_20km/scalar_output_ANT_00001.nc'];
