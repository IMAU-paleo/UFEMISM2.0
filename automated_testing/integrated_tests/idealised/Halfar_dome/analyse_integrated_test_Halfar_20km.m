function analyse_integrated_test_Halfar_20km( varargin)
% Analyse the results of the Halfar_20km integrated test

varargin = varargin{1};

disp('Analysing integrated test idealised/Halfar_dome/Halfar_20km...')
disp('')
  
test_name = 'Halfar_20km';
...
filename_config  = [foldername_test '/config_Halfar_20km.cfg'];
filename_results = [foldername_test '/results_Halfar_20km/main_output_ANT_00001.nc'];
...
% Read stability info
filename = [foldername_test '/results_Halfar_20km/scalar_output_ANT_00001.nc'];
