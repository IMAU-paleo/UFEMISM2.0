...
[HO,FS] = process_ISMIP_HOM_ensemble_experiment_A( foldername_ensemble);
...
line( 'parent',H.Ax{ 2,3},'xdata',[],'ydata',[],'color','k','linewidth',2,'linestyle',ls_SIASSA);
line( 'parent',H.Ax{ 2,3},'xdata',[],'ydata',[],'color','k','linewidth',2,'linestyle',ls_DIVA);
line( 'parent',H.Ax{ 2,3},'xdata',[],'ydata',[],'color','k','linewidth',2,'linestyle',ls_BPA);
