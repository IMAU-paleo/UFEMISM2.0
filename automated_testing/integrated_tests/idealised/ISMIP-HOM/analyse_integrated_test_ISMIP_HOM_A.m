function analyse_integrated_test_ISMIP_HOM_A( varargin)
% Analyse the results of the ISMIP-HOM experiment A integrated test

varargin = varargin{1};

disp('Analysing integrated test idealised/ISMIP-HOM/experiment_A...')
disp('')
