...
disp('Analysing integrated test idealised/ISMIP-HOM/experiment_C...')
disp('')
...
[HO,FS] = process_ISMIP_HOM_ensemble_experiment_C( [foldername_ISMIP_HOM '/ismip_all']);
...
for Li = 1:6
  ...
  for approxi = 1:3
    ...
    foldername = [foldername_test '/results_ISMIP_HOM_C_' num2str(L) '_' approx];
