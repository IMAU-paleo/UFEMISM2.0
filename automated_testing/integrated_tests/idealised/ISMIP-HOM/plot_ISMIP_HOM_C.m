...
[HO,FS] = process_ISMIP_HOM_ensemble_experiment_C( foldername_ensemble);
...
set( H.Ax{ 1,3},'ylim',[10,24]);
set( H.Ax{ 2,1},'ylim',[0,40]);
set( H.Ax{ 2,2},'ylim',[0,80]);
set( H.Ax{ 2,3},'ylim',[0,160]);
