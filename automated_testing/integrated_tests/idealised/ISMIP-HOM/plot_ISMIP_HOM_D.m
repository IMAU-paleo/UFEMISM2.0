...
[HO,FS] = process_ISMIP_HOM_ensemble_experiment_D( foldername_ensemble);
...
set( H.Ax{ 1,1},'ylim',[0,20]);
set( H.Ax{ 1,2},'ylim',[0,24]);
set( H.Ax{ 1,3},'ylim',[0,30]);
set( H.Ax{ 2,1},'ylim',[0,60]);
set( H.Ax{ 2,2},'ylim',[0,200]);
set( H.Ax{ 2,3},'ylim',[0,400]);
