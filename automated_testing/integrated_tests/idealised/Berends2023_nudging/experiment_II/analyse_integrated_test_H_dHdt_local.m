function analyse_integrated_test_H_dHdt_local( varargin)
...
% Inverted values
filename = [foldername_test '/results_03_exp_II_inversion_5km_H_dHdt_local/main_output_ANT_00001.nc'];
...
filename = [foldername_test '/results_03_exp_II_inversion_5km_H_dHdt_local/scalar_output_ANT_00001.nc'];
...
write_to_scoreboard_file( r95_till_friction_angle, ...
  ...
  function write_to_scoreboard_file( r95_till_friction_angle, ...
    ...
    single_run = initialise_single_test_run( [test_name '_H_dHdt_local'], test_path);
