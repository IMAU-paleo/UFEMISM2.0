...
test_path = 'integrated_tests/idealised/Berends2023_nudging/experiment_II';
...
% Target values
filename = [foldername_test '/results_01_exp_II_spinup_5km/main_output_ANT_00003.nc'];
...
% Inverted values
filename = [foldername_test '/results_02_exp_II_inversion_5km/main_output_ANT_00001.nc'];
...
ice_density = 910;
TAF = Hi_target - max( 0, -Hb_target * (seawater_density / ice_density));
mask_gr_a = TAF > 0;
...
r95_till_friction_angle = calc_95th_percentile_ratio( phi_fric_target(  mask_gr_a), phi_fric_inverted(  mask_gr_a));
...
filename = [foldername_test '/results_02_exp_II_inversion_5km/scalar_output_ANT_00001.nc'];
