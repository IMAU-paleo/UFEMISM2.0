function analyse_integrated_test_H_u_flowline( varargin)
...
% Inverted values
filename = [foldername_test '/results_04_exp_II_inversion_5km_H_u_flowline/main_output_ANT_00001.nc'];
...
filename = [foldername_test '/results_04_exp_II_inversion_5km_H_u_flowline/scalar_output_ANT_00001.nc'];
...
write_to_scoreboard_file( r95_till_friction_angle, ...
  ...
  function write_to_scoreboard_file( r95_till_friction_angle, ...
    ...
    single_run = initialise_single_test_run( [test_name '_H_u_flowline'], test_path);
