...
% Inverted values
filename = [foldername_test '/results_05_exp_I_inversion_5km_H_dHdt_flowline/main_output_ANT_00001.nc'];
time = ncread( filename,'time'); ti = length( time);
...
mask_a = Hs_target > 2 & R_shear_target > 0.05;
...
filename = [foldername_test '/results_05_exp_I_inversion_5km_H_dHdt_flowline/scalar_output_ANT_00001.nc'];
