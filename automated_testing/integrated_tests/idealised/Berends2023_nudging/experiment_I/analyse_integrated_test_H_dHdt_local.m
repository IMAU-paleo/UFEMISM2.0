...
% Inverted values
filename = [foldername_test '/results_06_exp_I_inversion_5km_H_dHdt_local/main_output_ANT_00001.nc'];
time = ncread( filename,'time'); ti = length( time);
...
filename = [foldername_test '/results_06_exp_I_inversion_5km_H_dHdt_local/scalar_output_ANT_00001.nc'];
