...
% Inverted values
filename = [foldername_test '/results_07_exp_I_inversion_5km_H_u_flowline/main_output_ANT_00001.nc'];
time = ncread( filename,'time'); ti = length( time);
...
filename = [foldername_test '/results_07_exp_I_inversion_5km_H_u_flowline/scalar_output_ANT_00001.nc'];
