...
! =================
  ...
  TYPE type_BMB_model
    ...
    REAL(dp), DIMENSION(:    ), ALLOCATABLE :: BMB_smooth                  ! [m.i.e./yr] Reference basal mass balance (e.g. inverted or prescribed)
    REAL(dp), DIMENSION(:    ), ALLOCATABLE :: BMB_ROI                     ! [m.i.e./yr] Reference basal mass balance (e.g. inverted or prescribed)
