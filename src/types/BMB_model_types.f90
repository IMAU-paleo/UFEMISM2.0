...
! =================
  ...
  TYPE type_BMB_model
    ...
    REAL(dp), DIMENSION(:    ), ALLOCATABLE :: BMB_smooth                  ! [m.i.e./yr] Basal mass balance smoothed from inversion to modelled
    REAL(dp), DIMENSION(:    ), ALLOCATABLE :: BMB_modelled                ! [m.i.e./yr] Basal mass balance modelled (needs to be saved for computation BMB_smooth)
