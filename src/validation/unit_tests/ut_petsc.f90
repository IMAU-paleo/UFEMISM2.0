...
#include <petsc/finclude/petscksp.h>
  ...
  use CSR_sparse_matrix_utilities, only: deallocate_matrix_CSR_dist, multiply_CSR_matrix_with_vector_1D
...
contains
  ...
  subroutine unit_tests_petsc_main( test_name_parent)
    ...
    ! Run all unit tests for the PETSc subroutines
    call test_multiply_CSR_matrix_with_vector_1D( test_name)
