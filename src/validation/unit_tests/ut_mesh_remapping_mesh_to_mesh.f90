...
subroutine test_remapping_mesh_to_mesh( test_name_parent)
  ...
  subroutine test_remapping_mesh_to_mesh_identity( test_name_parent)
    ...
    call allocate_mesh_primary( mesh_nV5    , 'mesh_nV5'    , 100, 200, 100, C%nC_mem)
    call allocate_mesh_primary( mesh_nV9    , 'mesh_nV9'    , 100, 200, 100, C%nC_mem)
    call allocate_mesh_primary( mesh_nV16   , 'mesh_nV16'   , 100, 200, 100, C%nC_mem)
    call allocate_mesh_primary( mesh_refined, 'mesh_refined', 100, 200, 100, C%nC_mem)
    ...
    call create_map_from_mesh_to_mesh_nearest_neighbour( mesh_nV5    , mesh_nV5    , map_nV5_nearest_neighbour)
    call create_map_from_mesh_to_mesh_nearest_neighbour( mesh_nV9    , mesh_nV9    , map_nV9_nearest_neighbour)
    call create_map_from_mesh_to_mesh_nearest_neighbour( mesh_nV16   , mesh_nV16   , map_nV16_nearest_neighbour)
    call create_map_from_mesh_to_mesh_nearest_neighbour( mesh_refined, mesh_refined, map_refined_nearest_neighbour)

    call create_map_from_mesh_to_mesh_trilin( mesh_nV5    , mesh_nV5    , map_nV5_trilin)
    call create_map_from_mesh_to_mesh_trilin( mesh_nV9    , mesh_nV9    , map_nV9_trilin)
    call create_map_from_mesh_to_mesh_trilin( mesh_nV16   , mesh_nV16   , map_nV16_trilin)
    call create_map_from_mesh_to_mesh_trilin( mesh_refined, mesh_refined, map_refined_trilin)

    call create_map_from_mesh_to_mesh_2nd_order_conservative( mesh_nV5    , mesh_nV5    , map_nV5_2nd_order_conservative)
    call create_map_from_mesh_to_mesh_2nd_order_conservative( mesh_nV9    , mesh_nV9    , map_nV9_2nd_order_conservative)
    call create_map_from_mesh_to_mesh_2nd_order_conservative( mesh_nV16   , mesh_nV16   , map_nV16_2nd_order_conservative)
    call create_map_from_mesh_to_mesh_2nd_order_conservative( mesh_refined, mesh_refined, map_refined_2nd_order_conservative)
