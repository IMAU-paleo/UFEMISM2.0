...
contains
  ...
  subroutine test_trace_line_grid_cx( test_name_parent, grid)
    ...
    character(len=1024), parameter :: test_name_local = 'trace_line_grid_cx'
  ...
  subroutine test_trace_line_grid_cx_q_on_cx( test_name_parent, grid)
    ...
    ! DENK DROM
    if (par%master) call warning('DENK DROM - test_trace_line_grid_cx_q_on_cx'//&
  ...
  subroutine test_trace_line_grid_cx_q_in_a( test_name_parent, grid)
    ...
    ! DENK DROM
    if (par%master) call warning('DENK DROM - test_trace_line_grid_cx_q_in_a'//&
      ' only loops over grid interior; trace_line_grid_a'//&
      ' cannot yet handle the border cells properly; fix this!')
    do i = 2, grid%nx-2
    do j = 2, grid%ny-1
  ...
  subroutine test_trace_line_grid_cx_pq_through_b( test_name_parent, grid)
    ...
    ! DENK DROM
    if (par%master) call warning('DENK DROM - test_trace_line_grid_cx_pq_through_b'//&
      ' only loops over grid interior; trace_line_grid_a'//&
      ' cannot yet handle the border cells properly; fix this!')
    do i = 2, grid%nx-2
    do j = 2, grid%ny-1
  ...
  subroutine test_trace_line_grid_cx_pq_through_a( test_name_parent, grid)
    ...
    ! DENK DROM
    if (par%master) call warning('DENK DROM - test_trace_line_grid_cx_pq_through_a'//&
      ' only loops over grid interior; trace_line_grid_a'//&
      ' cannot yet handle the border cells properly; fix this!')
    do i = 2, grid%nx-2
    do j = 2, grid%ny-1
