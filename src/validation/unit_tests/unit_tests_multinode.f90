...
contains
  ...
  subroutine run_all_multinode_unit_tests
    ...
    call check_for_unit_tests_output_folder
    call check_for_unit_tests_output_file
  ...
  subroutine check_for_unit_tests_output_file
  ...
  subroutine check_for_unit_tests_output_folder
