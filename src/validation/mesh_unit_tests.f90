...
! =======================
  ...
  ! =============
    ...
    IF (do_write_results_to_netcdf) THEN
      ...
      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'd_a_ex'     , d_a_ex     )
      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddx_a_ex'   , ddx_a_ex   )
      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddy_a_ex'   , ddy_a_ex   )

      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd_b_ex'     , d_b_ex     )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddx_b_ex'   , ddx_b_ex   )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddy_b_ex'   , ddy_b_ex   )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dx2_b_ex' , d2dx2_b_ex )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dxdy_b_ex', d2dxdy_b_ex)
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dy2_b_ex' , d2dy2_b_ex )

      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'd_c_ex'     , d_c_ex     )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddx_c_ex'   , ddx_c_ex   )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddy_c_ex'   , ddy_c_ex   )

      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd_a_b'      , d_a_b      )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'd_a_c'      , d_a_c      )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'd_b_a'      , d_b_a      )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'd_b_c'      , d_b_c      )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'd_c_a'      , d_c_a      )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd_c_b'      , d_c_b      )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddx_a_a'    , ddx_a_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddx_a_b'    , ddx_a_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddx_a_c'    , ddx_a_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddx_b_a'    , ddx_b_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddx_b_b'    , ddx_b_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddx_b_c'    , ddx_b_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddx_c_a'    , ddx_c_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddx_c_b'    , ddx_c_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddx_c_c'    , ddx_c_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddy_a_a'    , ddy_a_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddy_a_b'    , ddy_a_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddy_a_c'    , ddy_a_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddy_b_a'    , ddy_b_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddy_b_b'    , ddy_b_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddy_b_c'    , ddy_b_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_notime(   filename, ncid, 'ddy_c_a'    , ddy_c_a    )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'ddy_c_b'    , ddy_c_b    )
      CALL write_to_field_multiple_options_mesh_dp_2D_c_notime( filename, ncid, 'ddy_c_c'    , ddy_c_c    )

      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dx2_b_b'  , d2dx2_b_b  )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dxdy_b_b' , d2dxdy_b_b )
      CALL write_to_field_multiple_options_mesh_dp_2D_b_notime( filename, ncid, 'd2dy2_b_b'  , d2dy2_b_b  )
