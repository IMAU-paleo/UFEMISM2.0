...
#include <petsc/finclude/petscksp.h>
  ...
  use SSA_main, only: initialise_SSA_solver, solve_SSA, remap_SSA_solver, create_restart_file_SSA, write_to_restart_file_SSA
  use DIVA_main, only: initialise_DIVA_solver, solve_DIVA, remap_DIVA_solver, create_restart_file_DIVA, write_to_restart_file_DIVA
