module netcdf_read_field_from_xy_grid_file
  ...
  public :: read_field_from_xy_file_2D, read_field_from_xy_file_2D_int, read_field_from_xy_file_2D_monthly, &
    read_field_from_xy_file_3D, read_field_from_xy_file_3D_ocean
